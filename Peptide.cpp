...
double Peptide::monoisotopicMZInternalFragment(unsigned int startAAPos, unsigned int endAAPos, unsigned int charge, char type) {
 
  double mz = monoisotopicMZFragment(type, endAAPos, charge);
